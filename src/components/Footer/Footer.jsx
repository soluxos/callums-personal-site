      ...
      <div className="flex flex-col justify-between gap-10 lg:flex-row">
        <div className="flex flex-1 flex-col gap-10 md:flex-row">
          ...
          <div className="w-[223px]">
            ...
            <div className="mt-5 space-y-[14px] text-[14px] font-medium leading-[1.5] text-[#929292] flex flex-col gap-3">
              <Link href="/case-studies/drupal-canvas" className="flex gap-2 ">
                Drupal Canvas
              </Link>
              <Link href="/case-studies/acquia-unification" className="flex gap-2 ">
                Acquia Unification
              </Link>
          ...
          <div className="w-[223px]">
            ...
            <div className="mt-5 space-y-[14px] text-[14px] font-medium leading-[1.5] text-[#929292] flex flex-col gap-3">
              <Link href="https://www.linkedin.com/in/callumharrod/" className="">
                LinkedIn
              </Link>
              <Link href="https://github.com/soluxos" className="">
                Github
              </Link>
            </div>
          </div>
