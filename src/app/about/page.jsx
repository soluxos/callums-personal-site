    ...
    <main className="flex flex-col gap-[120px]">
      <FadeInUp>
        <section className="w-full max-w-full">
          <div className="space-y-4 text-[14px] font-medium leading-[1.5] gap-10 flex flex-col">
              ...
              <div className="grid gap-10 lg:grid-cols-2">
                <div className="space-y-4 text-[14px] font-medium leading-[1.5] text-[#929292]">
                  <p>
                    ...
                    quickly I was messing about trying to make my own applications and websites.
                    Ever since then I knew that I wanted to work with computers. From that point I
                    carried on nerding out about how things were made so that I could do it myself.
                  </p>
                </div>
                <div className="space-y-4 text-[14px] font-medium leading-[1.5] text-[#929292]"></div>
              </div>
            </div>
            <div
              key={`about-card`}
